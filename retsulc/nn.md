This is my random brainstorming session about a business problem when I should trigger in such a way that there are no false alerts and missing files for the users.
...
And here is the high level problem statement:
